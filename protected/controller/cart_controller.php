    ...
    public function action_index()
    {
        switch(vds_request('step', null, 'get'))
        {
            ...
            case 'remove':
                ...
                if(cart::update('remove', vds_request('key', ''))) echo 1; else echo 0;
        ...
        switch(vds_request('step', null, 'get'))
        {
            ...
            case 'submit':
                ...
                if($shipping_amount >= 0)
                {
                    ...
                    {
                        $this->prompt('error', '支付方式不正确,请重新确认');
                    }
                }
                else
                {
                    $this->prompt('error', '无法获取正确的运费数据,请重新确认');
                }
            ...
            default:
                ...
                $this->tpl_display('order_confirm.html');
        }
    }
