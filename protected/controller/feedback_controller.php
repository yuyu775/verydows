...
class feedback_controller extends general_controller
{
    public function action_index()
    {
        ...
        $this->tpl_display('user_feedback_list.html');
    }
    ...
    public function action_view()
    {
        ...
        if($feedback = $feedback_model->find(array('fb_id' => $fb_id, 'user_id' => $user_id)))
        {
            ...
            $this->tpl_display('user_feedback_details.html');
        }
        else
        {
    ...
    public function action_apply()
    {
        ...
        if(vds_request('step', null, 'get') == 'submit')
        {
            ...
            if(TRUE === $verifier)
            {
                ...
                $this->prompt('success', '提交成功', url('feedback', 'index'));
            }
            else
            {
        ...
        else
        {
            ...
            $this->tpl_display('user_feedback_apply.html');
        }
    }
    ...
    {
        $user_id = $this->is_logged();
        $fb_id = intval(vds_request('id', null));
        $feedback_model = new feedback_model();
